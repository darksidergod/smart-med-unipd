...
function usage {
    ...
    echo " Signs the channel transaction file with identity of admin from organisation admin."
}
...
CHANNEL_TX_FILE=/vagrant/demoforlab/orderer/multi-org-ca/healthcare-channel.tx
...
# peer channel join -o localhost:7050 -b $PWD/../../orderer/multi-org-ca/healthcare-channel.tx